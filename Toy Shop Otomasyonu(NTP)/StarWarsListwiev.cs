...
{
    public partial class StarWarsListwiev : Form
    {
        public StarWarsListwiev()
        {
            InitializeComponent();
        }
        SQLbaglanti bgl = new SQLbaglanti();
        private void StarWarsListwiev_DoubleClick(object sender, EventArgs e)
        {
        ...
        void goster()
        {
            ...
            if (bgl.baglanti().State == ConnectionState.Closed) //Bağlantı kapalıysa aç
                bgl.baglanti().Open();
            SqlCommand komut = new SqlCommand("select * from Tbl_Satis WHERE Kategori='"+"Star Wars"+"'", bgl.baglanti());
            SqlDataReader oku = komut.ExecuteReader();
            while (oku.Read())
            {
        ...
        private void StarWarsListwiev_Load(object sender, EventArgs e)
        {
        ...
        private void StarWarsListwiev_FormClosing(object sender, FormClosingEventArgs e)
        {
            string hatirla = "";
            if (bgl.baglanti().State == ConnectionState.Closed) //Bağlantı kapalıysa aç
                bgl.baglanti().Open();
